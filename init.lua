...
vim.keymap.set('n', '<leader>sf', require('telescope.builtin').buffers, { desc = '[ ] Find existing buffers' })
...
-- Then apply WebStorm TS highlights
require("custom.configs.syntax_colors").setup()
